			...
			<div className={styles.messagePage}>
				...
				<section className={styles.messageContent}>
					...
					<div className={styles.messageBottom}>
						<Row gutter={20} className={styles.messageBotBox}>
							<Col {...this.columns} className={`${styles.messageBotCol} animated fadeInDown `}>
								<div className={`${styles.messageInfo}`}>
									<img src={message1} alt="" />
									<h3>多渠道采集</h3>
									<p>利用数据挖掘技术，从微信、微博、门户网页等互联网多渠道进行数据采集，为web内容的统一管理环节提供数据、资讯内容支撑。</p>
								</div>
							</Col>
							<Col {...this.columns} className={`${styles.messageBotCol} animated fadeInDown `}>
								<div className={styles.messageInfo}>
									...
									<h3>融合编辑</h3>
									<p>
										提供了高度集成的融合编辑工作台，在此工作台下支持对图文、视频、专题等多媒体数据进行多功能编辑，支持文章编辑视图、区块视图、页面部件视图、回收站视图和评论视图等多维度的视图展现。
									</p>
								</div>
							</Col>
							<Col {...this.columns} className={`${styles.messageBotCol} animated fadeInDown `}>
								<div className={styles.messageInfo}>
									...
									<h3>统一发布</h3>
									<p>
										系统支持电视端、PC端、移动客户端、html5等多终端平台的内容发布，能够将网站的文章、组图、视频、音频和专题等多种丰富的内容类型在不同终端进行展现，带给客户畅快淋漓的阅读体验。
									</p>
								</div>
							</Col>
						</Row>
